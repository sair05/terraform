# 1. Cluster Role: Allows EKS to manage resources
...
# Attach the required policy for the Control Plane
resource "aws_iam_role_policy_attachment" "eks_cluster_policy" {
  policy_arn = "arn:aws:iam::aws:policy/AmazonEKSClusterPolicy"
  role       = aws_iam_role.eks_cluster.name
}

# 2. Node Role: Allows EC2 workers to connect to EKS and pull Docker images
...
# Essential policies for Worker Nodes
